...
def t(word, message=None, user=None) -> object:
    ...
    words_uz = {
        "Paketlar narxi" : "Qadoqlash narxi 📦",
        'qabul_qilindi': "Sizning buyurtmangiz qabul qilindi✅",
        'phone_number_warning': "❌ Iltimos, telefon raqamingizni quyidagi formatda (+998990000000) yoki telegramdagi telefon nomerni ulashish tugmasi orqali kiritin", 
        ...
        'Register': "➕ Ro'yxatdan o'tish / Регистрация",
        'uz til': "🇺🇿 O'zbekcha",
        'ru til': "🇷🇺 Русский",
